(function () {
  ...
  function crearInterfaz() {
    if (document.getElementById("pwaBarraEstado")) return;
    ...
    barra.innerHTML = `
      ...
      <div class="pwa-acciones">
        <span id="pwaEstadoConexion" class="pwa-conexion" role="status" aria-live="polite"></span>
        <button id="pwaBotonInstalar" class="pwa-boton-instalar" type="button" hidden>
    ...
    document.getElementById("pwaBotonInstalar")
  ...
  function actualizarEstadoConexion() {
    ...
    estado.className = `pwa-conexion ${online ? "pwa-online" : "pwa-offline"}`;
  ...
  function mostrarAyudaIOS() {
    ...
    fondo.innerHTML = `
      <section class="pwa-modal" role="dialog" aria-modal="true" aria-labelledby="pwaTituloIOS">
        <button class="pwa-modal-cerrar" type="button" aria-label="Cerrar">×</button>
    ...
    fondo.querySelector(".pwa-modal-cerrar").addEventListener("click", () => fondo.remove());
